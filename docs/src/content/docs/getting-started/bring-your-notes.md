---
title: Import Markdown And Obsidian Notes
description: Import a markdown file, folder, or Obsidian vault into Metakip, then verify titles, content, images, links, and folders.
---

You can start with no pages or bring notes you already have. Metakip can import one markdown file, a markdown folder, or an Obsidian vault.

## Before You Begin

Have the file, folder, or Obsidian vault available on the computer where you are using Metakip. Keep an untouched copy of the original until you have checked the imported pages.
...
When Metakip asks how you want to get started, choose **Import Content**.
...
- If a title is wrong, rename the page in Metakip after checking the source filename.
...
Do not reorganize everything at once. Keep using Metakip and improve the structure when you notice a real problem.

For the syntax available after importing, see [Markdown Support](/getting-started/markdown-support/). For a repeatable terminal workflow, see [Metakip CLI](/agents/metakip-cli/).
